...
http.createServer(function(request, response) {
    ...
    else if (uri == "/getTitle")
    {
      api.getTitle(config,url.queryString,function(title){
          var headers = {};
          headers["Content-Type"] = "text/json";
          response.writeHead(200, headers);
    ...
    {
      api.move(config,url.queryString,function(success){
          var headers = {};
    ...
    {
      api.erase(config,url.queryString,function(success){
          var headers = {};
          headers["Content-Type"] = "text/plain";
          response.writeHead(200, headers);
          if(success)
